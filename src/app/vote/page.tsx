          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-50 to-violet-50 p-4 sm:p-5">
              ...
              <div className="mt-3 space-y-3 text-sm leading-relaxed text-slate-700">
                <p>
                  ✅ ด้วยหมู่บ้าน เราต้องเร่งรัดดำเนินการ จากการให้คำแนะนำของเจ้าหน้าที่กรมที่ดิน
                </p>
                <p>
                  ทางคณะทำงานจิตอาสาจึงมีความจำเป็นต้องเสนอชื่อและแต่งตั้งตัวแทนจำนวน5ท่าน เพื่อเป็นตัวแทนของพวกเรา ในการไปพบเจ้าพนักงานที่ดิน ณ ที่ดินสาขาหางดงเพื่อยื่นเอกสารและประสานงานตามกฎหมายเกี่ยวกับการจัดตั้งนิติบุคคลเสร็จโดยเร็ว
                </p>
                <p>
                  📌 ทางคณะทำงานจึงขอความร่วมมือจากท่านเจ้าของแปลงที่ดิน โปรด พิจารณาและลงนามในใบรับรองและอำนาจ ให้ตัวแทนดำเนินการแทนพวกท่าน
                </p>
                <p>จึงเรียนมาเพื่อโปรดให้ความร่วมมือและ ขอขอบพระคุณณโอกาสนี้</p>
                <p className="font-semibold text-indigo-900">กลุ่มจิตอาสา ดีญ่า วาเลย์ หางดง</p>
              </div>
            </div>
