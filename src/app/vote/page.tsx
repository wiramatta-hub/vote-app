          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-50 to-violet-50 p-4 sm:p-5">
              ...
              <div className="mt-3 space-y-3 text-sm leading-relaxed text-slate-700">
                <p>
                  ด้วยหมู่บ้าน ดีญ่าวาเลย์ หางดง ของเรามีความจำเป็นต้องเร่งรัดจัดตั้งนิติบุคคล เพื่อให้มีองค์กรที่เป็นทางการในการรับโอนและบริหารจัดการทรัพย์สินส่วนกลาง สาธารณูปโภคตลอดจนดูแลความปลอดภัยและความเป็นระเบียบเรียบร้อยภายในโครงการร่วมกัน
                </p>
                <p>
                  ทางคณะทำงานจิตอาสาจึงมีความจำเป็นต้องเสนอชื่อและแต่งตั้งตัวแทนจำนวน 5 ท่านเพื่อเป็นตัวแทนของลูกบ้านในการไปพบเจ้าพนักงานที่ดิน ณ ที่ดิน สาขาหางดง เพื่อยื่นเอกสารและประสานงานตามกฎหมายเกี่ยวกับการจัดตั้งนิติบุคคลให้เสร็จโดยเร็ว
                </p>
                <p>
                  ทางคณะทำงานจึงขอความร่วมมือจากท่านเจ้าของแปลงที่ดิน โปรดพิจารณาและลงนามในใบรับรองและอำนาจให้ตัวแทนดำเนินการแทนพวกท่าน
                </p>
                <p>จึงเรียนมาเพื่อโปรดให้ความร่วมมือ</p>
                <p className="font-semibold text-indigo-900">กลุ่มจิตอาสา ดีญ่าวาเลย์ หางดง</p>
              </div>
            </div>
